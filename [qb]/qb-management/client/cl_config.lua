...
Config.BossMenuZones = {
    ...
    ['ambulance'] = {
        { coords = vector3(382.01, -1411.16, 37.45), length = 1.2, width = 0.6, heading = 341.0, minZ = 43.13, maxZ = 43.73 },
    },
    ['realestate'] = {
    ...
    ['cardealer'] = {
        { coords = vector3(-32.34, -1114.30, 25.72), length = 2.4, width = 1.05, heading = 340.0, minZ = 27.07, maxZ = 27.67 },
    },
    ['noremorse'] = {
