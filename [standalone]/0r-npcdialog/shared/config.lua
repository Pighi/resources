Config = {
    ...
    Dialogs = {
        ...
        { -- liberty jobs pay center
            Ped = {
                Enable = true,
                coords = vector4(-1088.41, -253.0, 37.76, 271.8),
                hash = "a_m_m_soucent_02", -- Check here https://docs.fivem.net/docs/game-references/ped-models/
                animDict = "amb@world_human_hang_out_street@female_arms_crossed@idle_a",
                animName = "idle_a"
            },
            ...
            AutoMessage = { -- This is an automatic message system that sends automatic message when you open dialog menu.
                Enable = true,
                AutoMessages = {
                    {type = "question", text = "Welcome, Check and Recieve your Payout."},
                    --{type = "message",  text = "This is an automatic message."}
                }
            },
            Buttons = {
                [1] = { -- Button 1 and answers
                    label = "Check Payslip",
                    systemAnswer = {enable = false, type = "question", text = "You want to renew your identity card?"},
                    playerAnswer = {enable = false, text = "Yes I lost it, I need new one!"},
                    maxClick = 2,
                    onClick = function()
                ...
                [2] = { -- Button 2 and answers
                    ...
                    systemAnswer = {enable = false, type = "message", text = "You want to renew your driver license?"},
                    playerAnswer = {enable = false, text ="Yes I lost it, I need new one!"},
                    maxClick = 1,
                    onClick = function()
