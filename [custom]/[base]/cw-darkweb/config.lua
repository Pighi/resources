...
Config.DarkwebAds = {
    { -- basic example
        title = "Combat Pistol",
        description = 'This is a compact pistol',
        items = {
            { itemName = 'weapon_combatpistol', amount = 1, metadata = nil },
        },
        price = { min = 1, max = 5 },
        chance = 100 -- chance of being included in list, defaults to 100. 100 = 100% chance
    },
