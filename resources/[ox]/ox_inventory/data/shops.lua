return {
	...
	PoliceArmoury = {
		...
		groups = shared.police,
		 inventory = {
			...
			vec3(-1074.88, -816.58, 15.64)
		}, targets = {
			--{ loc = vec3(453.21, -980.03, 30.68), length = 0.5, width = 3.0, heading = 270.0, minZ = 30.5, maxZ = 32.0, distance = 6 },
			{
                ped = `s_m_y_cop_01`,
                scenario = 'WORLD_HUMAN_AA_COFFEE',
                loc = vec3(-1074.88, -816.58, 14.64),
                heading = 123.00,
            },
		}
	},
	...
	Pharmacy = {
		...
		inventory = {
			...
			vec3(351.75, -1400.93, 32.5)
		}, targets = {
			--{ loc = vec3(1134.46, -468.17, 66.49), length = 0.5, width = 3.0, heading = 228.04, minZ = 29.29 - 2, maxZ = 29.29 + 1, distance = 2 },
			{
                ped = `s_m_m_scientist_01`,
                scenario = 'WORLD_HUMAN_AA_COFFEE',
                loc = vec3(351.75, -1400.93, 31.5),
                heading = 46.97,
            },
		}
	},
	Pharmacy2 = {
		name = 'Doctors Pharmacy Store',
		groups = {
			['ambulance'] = 0
		},
		inventory = {
			...
			vec3(367.6, -1391.56, 32.5)
		}, targets = {
			--{ loc = vec3(1134.46, -468.17, 66.49), length = 0.5, width = 3.0, heading = 228.04, minZ = 29.29 - 2, maxZ = 29.29 + 1, distance = 2 },
			{
                ped = `s_m_m_scientist_01`,
                scenario = 'WORLD_HUMAN_AA_COFFEE',
                loc = vec3(367.6, -1391.56, 31.5),
                heading = 315.67,
            },
		}
	},
	...
	DigitalDen = {
		...
		inventory = {
			...
			vec3(1134.46, -468.17, 66.49)
		}, targets = {
			--{ loc = vec3(1134.46, -468.17, 66.49), length = 0.5, width = 3.0, heading = 228.04, minZ = 29.29 - 2, maxZ = 29.29 + 1, distance = 2 },
			{
                ped = `mp_m_shopkeep_01`,
                scenario = 'WORLD_HUMAN_AA_COFFEE',
                loc = vec3(1134.46, -468.17, 65.49),
                heading = 186.51,
            },
		}
	},
	Dark = {
		...
		inventory = {
			        { name = 'racing_gps',    price = 10 },
					{ name = 'cw_darkweb_tablet',       price = 10 },
					{ name = 'ls_jackstand', price = 10 },
					{ name = 'ls_jackstand_alt',      price = 10 },
					{ name = 'detector',     price = 10 },
		}, locations = {
			vec3(-28.61, -1319.0, 29.28)
		}, targets = {
			--{ loc = vec3(1134.46, -468.17, 66.49), length = 0.5, width = 3.0, heading = 228.04, minZ = 29.29 - 2, maxZ = 29.29 + 1, distance = 2 },
			{
                ped = `g_m_m_chicold_01`,
                scenario = 'WORLD_HUMAN_AA_COFFEE',
                loc = vec3(-28.61, -1319.0, 28.28),
                heading = 19.02,
            },
		}
	},
